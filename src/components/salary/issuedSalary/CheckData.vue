  ...
  <div ref="checkTable">
    ...
    >
      ...
      <template v-slot:pagination="scope">
        <div class="check-tips">系统匹配为无账户、异常数据均不会发送</div>
...
export default {
  ...
  computed: {
    ...mapState('salary', ['allSalaryDateAndType', 'currentDateAndType']),
    tabelData () {
      let columns = appConfig[this.moduleType].templateRequiredColumn
      return _.filter(this.checkList[this.salaryTab], item => {
        let flag = false
