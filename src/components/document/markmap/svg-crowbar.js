export default function (title) {
  ...
  function getSources (doc, styles) {
    ...
    [].forEach.call(svgs, function (svg) {
      ...
      //   ratio = Math.floor(window.innerWidth / rect.width)
      //   svg.lastElementChild.setAttribute('transform', 'translate(0, ' + window.innerHeight / 2 + ') scale(' + ratio + ')')
      // } else {
      //   ratio = Math.floor(window.innerHeight / rect.height)
      //   svg.lastElementChild.setAttribute('transform', 'translate(' + window.innerWidth / 2 + ', 0) scale(' + ratio + ')')
      // }
