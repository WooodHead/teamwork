  ...
  >
    <template slot="content">
      <q-card-section class="file-detail">
        ...
        <attach-card
          :attach="{createBy:currentModel.modifyBy, modifyBy:currentModel.modifyBy,filePath:currentModel.filePath,extension:currentModel.extension,title:currentModel.title,size:currentModel.size,snapshotPath:currentModel.snapshotPath,modifyTime:currentModel.modifyTime,tags:currentModel.tags}"
