  ...
  >
    <template slot="toolbar-left">
      <div class="row col items-center full-height q-px-sm providers">
        <q-icon name="mdi-sigma" /> {{$t('editor.blockFormula')}}
      </div>
    </template>
...
import { openUrl } from '@/components/base/q-editor/utils/shared'
...
// import '@/components/base/q-editor/css/katex/katex.min.css'
