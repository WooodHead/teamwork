          ...
          <q-item clickable>
            ...
            <q-item-section>
              ...
              <q-item-label
                caption
                lines="2"
              >(charging)</q-item-label>
            </q-item-section>
            <q-item-section side>
              <q-badge
                color="blue"
                class="text-uppercase"
              > {{ batteryInfos.charging }} </q-badge>
            </q-item-section>
          </q-item>
          <q-item clickable>
            <q-item-section avatar>
            ...
            <q-item-section>
              ...
              <q-item-label
                caption
                lines="2"
              >(charging Time)</q-item-label>
            </q-item-section>
            <q-item-section side>
              <q-badge
                color="blue"
                class="text-uppercase"
              > {{ batteryInfos.chargingTime }} </q-badge>
            </q-item-section>
          </q-item>
          <q-item clickable>
            <q-item-section avatar>
            ...
            <q-item-section>
              ...
              <q-item-label
                caption
                lines="2"
              >(discharging Time)</q-item-label>
            </q-item-section>
            <q-item-section side>
              <q-badge
                color="blue"
                class="text-uppercase"
              > {{ batteryInfos.dischargingTime }} </q-badge>
            </q-item-section>
          </q-item>
          <q-item clickable>
            <q-item-section avatar>
            ...
            <q-item-section side>
              <q-badge
                color="blue"
                class="text-uppercase"
              > {{ (batteryInfos.level * 100) }}% </q-badge>
            </q-item-section>
          </q-item>
        </q-list>
      </div>
...
<script>
import CpHead from 'components/web-apis/CompatibilityHead'
export default {
  name: 'PageBaterry',
  components: {
    CpHead
