...
export default {
  ...
  methods: {
    ...
    init (AMap) {
      ...
      AMap.plugin(['Map3D', 'AMap.DistrictLayer', 'AMap.Scale', 'AMap.ToolBar'], function () {
    ...
    labelData () {
      ...
      _.forEach(this.initDataSource, t => {
        ...
        if (this.directions[name]) {
          configCopy.text.direction = this.directions[t.name]
        }
